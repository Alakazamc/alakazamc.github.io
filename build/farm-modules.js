...
function build(){
 ...
 const sprite='<svg style="display:none" aria-hidden="true">'+['mailbox','wheat','flower'].concat(Object.values(KIND_ICON)).concat(DECOR_ICONS).filter(n=>ICONS[n]).map(n=>toSymbol(n,ICONS[n])).join('')+'</svg>';
