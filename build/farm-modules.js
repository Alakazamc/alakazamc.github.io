...
function build(){
 ...
 const sprite='<svg style="display:none" aria-hidden="true">'+['mailbox','wheat','flower','book','star'].map(n=>toSymbol(n,ICONS[n])).join('')+'</svg>';
